...
Die Anmelde- und Ersteinrichtungsseiten sind für kleine Displays, Displayausschnitte und die eingeblendete Bildschirmtastatur optimiert. Der Weiter-Button bleibt am unteren Rand erreichbar, während der Inhalt darüber separat scrollbar ist.


## Sommerferien und Klassenwechsel

In der Ersteinrichtung und unter **Einstellungen → Sommerferien & Klassenwechsel** kann ein vollständiger Ferienzeitraum eingetragen werden. Als lokaler Vorschlag ist **Winterthur / Kanton Zürich: 11. Juli bis 16. August** hinterlegt. Beginn und Ende können frei geändert werden. Der automatische Klassenwechsel erfolgt am Tag nach dem eingetragenen Ferienende.
